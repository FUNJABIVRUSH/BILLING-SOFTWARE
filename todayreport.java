 ...
 * @author vrushabh
 */
public class todayreport extends javax.swing.JFrame {

    /**
     * Creates new form todayreport
     */
    public todayreport() {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BILLNO", "TOTAL PRICE", "DISCOUNT", "FINAL TOTAL", "PAYED", "CREDIT"
            }
        ));
     ...
     private void date()
    {
        ...
        add(dateFormatter.format(now));
        wadd(dateFormatter.format(now));
    ...
    private void add(String a)
    {
        try{
            ...
            rs=st.executeQuery("select * from billdetail where date='"+a+"'");
           
            while(rs.next())
            {
                String billno=rs.getString("BILLNO");
                String total=rs.getString("TOTAL1");
                String disc=rs.getString("DISCOUNT");
                String total2=rs.getString("FINALTOTAL");
                String payed=rs.getString("PAYED");
                String credit=rs.getString("CREDIT");
                DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
                model.addRow(new Object[]{billno,total,disc,total2,payed,credit});
            }
    ...
    private void wadd(String a)
    {
        try{
            ...
            rs=st.executeQuery("select * from wbilldetail where date='"+a+"'");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            newDateFormat.applyPattern("E,dd/MM/yyyy");
            String MyDate=newDateFormat.format(MyDate1);
            DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
            model.setRowCount(0);
            add(MyDate);
            wadd(MyDate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(todayreport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
