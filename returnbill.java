...
public class returnbill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLayeredPane1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel12, jLabel13, jLabel14, jLabel15, jLabel16, jLabel17, jLabel9, jTextField10, jTextField6, jTextField7, jTextField8, jTextField9});
    ...
    private void update()
    {
        try{
            ...
            rs=st.executeQuery("select * from billdetail where NAMEOFPRODUCT='"+pname1+"' and SIZE='"+size1+"'and BILLNO='"+billno+"'");
            while(rs.next())
            {
                ...
                Float amount2=rs.getFloat("AMOUNT2");
                Float sgst=rs.getFloat("SGST");
                Float amount3=rs.getFloat("AMOUNT3");
                float namount1=qty2*rate;
                float namount2=namount1*cgst/100;
                float namount3=namount1*sgst/100;
                float total11=namount1+namount2+namount3;
                DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
                model.addRow(new Object[]{itemcode,pname1,size1,hsn,qty2,rate,namount1,cgst,namount2,sgst,namount3,total11});
            }
        }
        catch(Exception e)
        {
    ...
    private  float total1()
    {
     ...
     {
        total=Float.parseFloat(model.getValueAt(i,11).toString());
        total1=total1+total;              
    }
          ...
          try{
            ...
            for(int i=0;i<count;i++)   {
              ...
              int j=0;
                    ...
                    float ftot=total1();
                    float pbill1=0;
                    st.executeUpdate("update billdetail set ITEMCODE='"+itemcode[i]+"',NAMEOFPRODUCT='"+productname[i]+"',SIZE='"+size[i]+"',HSNCODE='"+hsncode[i]+"',QTY="+qty[i]+",RATE="+rate[i]+",AMOUNT1="+amount1[i]+",CGST="+cgst[i]+",AMOUNT2="+amount2[i]+",SGST="+sgst[i]+",AMOUNT3="+amount3[i]+",TOTAL="+total[i]+",DATE='"+date+"',FINALTOTAL="+ftotal+",TOTAL1="+ftot+",PAYED="+ftot+",CREDIT="+credit+" where BILLNO='"+billno+"'");
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        ...
        try{
            ...
            while(rs.next())
            {
                ...
                DefaultTableModel model=(DefaultTableModel)jTable1.getModel();
                model.addRow(new Object[]{itemcode,pname,psize,hsncode,qty,rate,amount1,cgst,amount2,sgst,amount3,total});
