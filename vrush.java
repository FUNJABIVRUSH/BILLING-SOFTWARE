 ...
 * @author vrushabh
 */
public class vrush extends javax.swing.JFrame {
...
private static String database="vrushabhl";
private static String user="root";
private static String pass="vru8390941303";
private static String path="C:\\Users";
private static String name2 ="KAPOORMACHINARYSTORE.sql";
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:

String dumpCommand = "mysqldump " + database + " -h " + ip + " -u " + user +" -p" + pass + database +" > "+name2;
...
exc.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vrush.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
