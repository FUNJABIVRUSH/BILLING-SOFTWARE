...
public class additem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setResizable(false);
        setSize(new java.awt.Dimension(1920, 1081));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon("C:\\Users\\vrushabh\\Desktop\\pics\\shopping-cart-insert-icon.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
          ...
          try
        {
            ...
            String hsn=jTextField3.getText();
            float gst=Float.parseFloat(jTextField4.getText());
            float rate=Float.parseFloat(jTextField5.getText());
            
            st.executeUpdate("insert into shop values('"+srno+"','"+name+"','"+size+"','"+hsn+"',"+gst+","+rate+");");
